...
import { ArrowLeft, BookHeart, CalendarCheck2, Check, CircleDot, Clock3, Flame, ListPlus, NotebookPen, Repeat, Sparkles } from 'lucide-react'
...
export function DashboardHome() {
  const { profile, tasks, notes, habits, planItems, toggleTask } = useCommandCenter()
