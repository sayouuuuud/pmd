...
import { Archive, Check, ChevronDown, Filter, GripVertical, Link2, ListPlus, Pencil, Plus, Save, Search, SlidersHorizontal, Trash2, X } from 'lucide-react'
...
type TaskRowProps = {
  ...
  onToggle: () => void
  onArchive: () => void
  onUpdate: (patch: Partial<Pick<Task, 'title' | 'priority' | 'dueLabel' | 'category'>>) => void
