...
import { Archive, Check, ChevronDown, Filter, Link2, ListPlus, Pencil, Plus, Save, Search, SlidersHorizontal, Trash2, X } from 'lucide-react'
...
function TaskRow({ task, projectId, projectTitle, goalId, goalTitle, onToggle, onArchive, onUpdate, onAddSubtask, onToggleSubtask, onRemoveSubtask }: TaskRowProps) {
