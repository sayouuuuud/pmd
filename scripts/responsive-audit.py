...
def main():
    ...
    with sync_playwright() as playwright:
        ...
        for viewport_name, width, height in VIEWPORTS:
            ...
            for route in ROUTES:
                ...
                record = {"viewport": viewport_name, "route": route, "screenshot": str(screenshot), "consoleErrors": console_errors}
                try:
    ...
    failures = [r for r in results if r.get("loadError") or (r.get("status") or 0) >= 400 or r.get("horizontalOverflow") or r.get("consoleErrors")]
